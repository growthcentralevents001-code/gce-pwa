...
export default function EventsContent() {
  ...
  const filteredEvents = events.filter(event =>
    activeTab === "all" || event.category?.toLowerCase() === activeTab.toLowerCase()
  );
  ...
  if (loading) {
    return <div className="max-w-7xl mx-auto px-4 py-12 text-center">Loading events...</div>;
  }
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">
          {urlQuery ? `Search results for "${urlQuery}"` : "All Events"}
        </h1>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden cursor-pointer hover:shadow-lg transition">
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-1 text-sm text-gray-600">
                      ...
                      <div className="flex items-center gap-1">
                        <span>👥</span> {event.registered} / {event.capacity} attending
                      </div>
                    </div>
