    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
          {/* Avatar Section - Full Width Orange Bar */}
          <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-6 flex items-center gap-4">
            <div className="relative">
              ...
              <button className="absolute bottom-0 right-0 bg-white rounded-full p-1 shadow-md hover:bg-orange-50 transition">
          ...
          <form onSubmit={handleSave} className="p-6 space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-orange-400 focus:border-transparent transition"
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-red-50 hover:bg-red-100 text-red-600 font-medium rounded-xl transition flex items-center justify-center gap-2"
              >
                <LogOut size={18} />
                Logout
              </button>
