...
| **Phase 13 note** | Admin / Operations & Support **COMPLETE on gce-dev** (`20260808240000_phase13_admin_operations_support`). Shared `ops_cases` umbrella linked to domain disputes; approval/exception projections; typed overrides; moderation; scoped suspension/termination via Phase 4; incident actions over Phase 12 signals; Finance console without ledger mutators; Support/RM/PRM scoped; no Super Admin product role; no self-approval. Money/settlement/payout/refund_processing/live notify/marketing/retention_enforcement OFF. Dirty `/admin` + UI WIP preserved unstaged. Phase 14 not started. |
