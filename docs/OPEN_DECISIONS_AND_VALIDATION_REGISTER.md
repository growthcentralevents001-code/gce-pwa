...
| **Phase 9 note** | Finance / Revenue / Commission / Settlement **COMPLETE on gce-dev** (`20260808200000_phase9_finance_revenue_commission_settlement`). Canonical revenue components + stakeholder entitlements; Connect 20% / Marketplace 80-10-10 & 80-0-20 / Enterprise 25% of platform commission; recovery separate from gross; reversals/holds/chargebacks/offline recon; settlement batches with execution forced OFF; ledger balance helper; webhook payload hash. Money flags OFF. Non-blocking: GST/TDS, refund %, MoR packing. Phase 10 not started. |
