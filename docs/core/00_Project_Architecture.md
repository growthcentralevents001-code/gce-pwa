...
Founder Decisions in `docs/founder-decisions/` are the highest business authority (FD-001, FD-020–FD-038). This architecture overview must not contradict them. Official domain per FD-001: **growthcentralevents.com**. Legal company: **Logixia Solutions Private Limited**; platform/master brand: **GCE** (FD-034). Prefer Connect BDP / Marketplace BDP / Enterprise BDP terminology. Connect BDP commercial rules: FD-025 (finance recovery amended by FD-029). Marketplace BDP operating rules: FD-033. Marketplace transaction / unattributed revenue / approval: FD-037. GCE Enterprise commercial and operating rules: FD-026 (platform/IT workflow — not ordinarily physical executor; exact legal role may vary by contract — FD-034); cross-vertical / quotation / Finance co-sign: FD-038. Membership commercial: FD-027. Membership approval / attribution / allocation: FD-036. Identity / role / workspace: FD-035. Revenue recognition / commercial classification: FD-028. Commission Engine / Marketplace attributed 80/10/10 / BDP finance recovery: FD-029 (Affiliate future-only; ZBP removed). Circle lifecycle: FD-024. Circle internal architecture and governance: FD-030. Dual Circle status mapping / activation credit: FD-032. AI Lead Assist / Lead Intelligence: FD-031 / `39_AI_Lead_Assist_Spec.md` (GCE Lead Intelligence Engine + Opportunity Desk; Stage-1 Core Lead Rights protected). Do not reconcile Founder Decision ambiguity by assumption (FD-032).
